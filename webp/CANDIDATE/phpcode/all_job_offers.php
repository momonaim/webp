      ...
      <div class="card border-blue mb-3  h-100 shadow-lg">
        ...
        <div class="card-body text-primary pb-1">
          <div class="card-title">
            <div class="row">
              <div class="col-lg-4">
                <h5 class="text-truncate"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          ...
          <a href="APPLY_NOW.php?job=<?php echo $row['job_id']; ?>" class="btn btn-blue text-center fs-4 hover3"
...
//if ($cardCount < $totalRows) {
//echo '<h5>no more results</h5>';
// code...
