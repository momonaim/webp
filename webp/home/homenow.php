    ...
    <div class="container ">
        ...
        <div class="row">
            <div class="container my-5 ">
                <div
                    class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg bg-white scroll1">
            ...
            <div class="col-lg-6 mb-4 mt-4 h-100 scroll2 hover2">
                <div class="card border-light-subtle border-5 shadow-lg me-0 me-lg-4">
                    ...
                    <div class="card-body text-center">
                        <h3 class="card-title" style=" font-weight: bold; font-family: Passion One, sans-serif;">WEBP
                            PLUS SERVICE!</h3>
            ...
            <div class="container my-5">
                <div
                    ...
                    <div class="col-lg-7 p-3 p-lg-5 pt-lg-3 scroll4">
                        ...
                        <p class="lead">Post a job in minutes with our highly advanced platform. Create an account,
                            describe your job, and publish – it's that simple. Find your ideal candidate faster than
                            ever before!</p>
                        <div class="d-grid gap-2 d-md-flex justify-content-md-start mb-4 mb-lg-3">
        ...
        <div class="row mt-5 mb-5 ">
                ...
                <div class="card h-100 shadow-lg">
                    <div class="card-body">
                        <h5 class="card-title" style=" font-weight: bold; font-family: Passion One, sans-serif;">CONNECT
                            ...
                            <h6 class="card-subtitle mb-2 text-body-secondary">Card subtitle</h6>
                            <p class="card-text">Webp provides you with direct access to a curated pool of top-tier
                                talent, ensuring that you connect with the best candidates for your organization's
                                needs. </p>
                            <a class="icon-link icon-link-hover"
                                style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);  font-weight: bold; font-family: Passion One, sans-serif;"
                                href="#">
            ...
            <div class="col-lg-4 mb-3 scroll7 hover1">
                <div class="card h-100 shadow-lg scroll4">
                    <div class="card-body">
                        <h5 class="card-title" style=" font-weight: bold; font-family: Passion One, sans-serif;">
