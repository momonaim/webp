                        ...
                        <tbody>
                            ...
                            try {
                                ...
                                $stmt = $conn2->prepare("SELECT *
                                        ...
                                        WHERE c.status = 1 AND jj.job_id = ?");
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="row">
                                        <div class="btn-group">
                                            <a href="admin_edit.php?edit=<?php echo $row['can_id']; ?>"
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="staticBackdrop<?php echo $row['can_id']; ?>"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer d-flex">
                                                            <a href="../pdf/cvpdf.php?id=<?php echo $row['can_id']; ?>&action=V"
                                                                class="btn btn-info btn-sm col-6">
                                                                Show CV</a>
                                                        </div>
                                                    </div>
                                            ...
                                            <a href="phpcode/admin_fake_delete.php?del=<?php echo $row['can_id']; ?>"
