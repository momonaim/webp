  ...
  <div class="container my-5 ">
    <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg bg-white scroll1">
      <div class="col-lg-7 p-3 p-lg-5 pt-lg-3  scroll1">
        ...
        <p class="lead">At WEBP.com, we understand the importance of finding not just a job, but a fulfilling and rewarding career. Our mission is to connect individuals with companies that prioritize employee satisfaction, growth, and well-being.</p>
        <div class="d-grid gap-2 d-md-flex justify-content-md-start mb-4 mb-lg-3">
          
          <button type="button" class="btn btn-outline-blue btn-lg px-4 py-1 fw-bold me-md-2 fs-2" style=" font-weight: bold; font-family: Passion One, sans-serif;">REGISTER NOW</button>
        </div>
      </div>
...
<div class="row">
  ...
  <div class="card-body text-center">
    <h3 class="card-title" style=" font-weight: bold; font-family: Passion One, sans-serif;">WEBP PLUS SERVICE!</h3>
    <p class="card-text">Subscribe to WEBP PLUS service now and gain access to an unlimited space of career opportunities and talent. Let us empower your success!</p>
...
<div class="row">
  <div class="container my-5">
    <div class="row pe-4 ps-0 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg bg-white scroll4">
      ...
      <div class="col-lg-7 p-3 p-lg-5 pt-lg-3 scroll4">
        ...
        <p class="lead">Post a job in minutes with our highly advanced platform. Create an account, describe your job, and publish – it's that simple. Find your ideal candidate faster than ever before!</p>
        <div class="d-grid gap-2 d-md-flex justify-content-md-start mb-4 mb-lg-3">
          
          <button type="button" class="btn btn-outline-blue btn-lg px-4 py-1 fw-bold me-md-2 fs-2" style=" font-weight: bold; font-family: Passion One, sans-serif;">POST A JOB</button>
  ...
  <div class="card-body">
    <h5 class="card-title" style=" font-weight: bold; font-family: Passion One, sans-serif;">EXPLORE DIVERSE CAREER OPPORTUNITIES
</h5>
    <h6 class="card-subtitle mb-2 text-body-secondary">Card subtitle</h6>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
   <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);  font-weight: bold; font-family: Passion One, sans-serif;" href="#" >
 ...
 READ MORE
  ...
  <div class="card h-100 shadow-lg" >
  <div class="card-body">
    <h5 class="card-title" style=" font-weight: bold; font-family: Passion One, sans-serif;">CONNECT WITH TOP-TIER TALENT
    <h6 class="card-subtitle mb-2 text-body-secondary">Card subtitle</h6>
    <p class="card-text">Webp provides you with direct access to a curated pool of top-tier talent, ensuring that you connect with the best candidates for your organization's needs. </p>
 <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);  font-weight: bold; font-family: Passion One, sans-serif;" href="#" >
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
  <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0M4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5z"/>
</svg>
 READ MORE
  ...
  <div class="card-body">
    <h5 class="card-title" style=" font-weight: bold; font-family: Passion One, sans-serif;">STREAMLINE YOUR HIRING PROCESS
</h5>
    <h6 class="card-subtitle mb-2 text-body-secondary">Card subtitle</h6>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
 <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);  font-weight: bold; font-family: Passion One, sans-serif;" href="#" >
