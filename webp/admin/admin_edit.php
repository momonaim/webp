...
<div class="">
        ...
        <form action="phpcode/phpcode.php" class="needs-validation" novalidate="" name="admin_form" id="admin_form" method="POST">
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" id="first_name" name="first_name" placeholder="" value="<?php echo $first_name; ?>" required="">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" id="last_name" name="last_name" placeholder="" value="<?php echo $last_name; ?>" required="">
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              ...
              <div class="input-group has-validation">
                ...
                <input type="text" class="form-control" id="username" name="username" placeholder="Username" value="<?php echo $admin_username; ?>" required="">
              <div class="invalid-feedback">
            ...
            <div class="col-md-5">
              ...
              <select class="form-select" id="admin_type" name="admin_type" required="">
                ...
                <option value="Super Admin" <?php if ($admin_type == 'Super Admin') echo 'selected'; ?>>Super Admin</option>
                <option value="Admin" <?php if ($admin_type == 'Admin') echo 'selected'; ?>>Admin</option>
     ...
     <div class="row ">
        <div class="col-md-6">
            <button type="submit" name="editbtn" id="editbtn" class="btn btn-block btn-success mb-2 w-100">Update</button>
        </div>
        <div class="col-md-6">
            <a href="admins.php" class=" w-100 btn btn-danger btn-block">CANCEL</a>
        </div>
        </div> 
        </form>
      </div>
